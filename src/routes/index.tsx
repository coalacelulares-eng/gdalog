...
const INITIAL_DATA = {
  drivers: [
    ...
    { id: "d2", nome: "GUSTAVO", cnh: "98765432100", telefone: "(19) 91234-5678", categoria: "E", status: "Ativo" },
  ] as Driver[],
  vehicles: [
    { id: "v1", placa: "AHV 9J29", modelo: "Volvo FH 460", motorista: "MARCOS", categoria: "LOGISTICA" },
    { id: "v2", placa: "OMN 6J00", modelo: "Scania R450", motorista: "GUSTAVO", categoria: "LOGISTICA" },
  ] as Vehicle[],
  expenses: [
    {
      id: "e1",
  ...
  oilChanges: [
    ...
    },
    {
      ...
      observacao: "Troca preventiva em oficina credenciada",
    },
  ] as OilChange[],
};
